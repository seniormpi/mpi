        ...
        try:
            ...
            if totalMass <= 0:
                ...
                if unit == "cm":
                    ...
                    totalVolumeString = "Total volume:" + str(totalVolume) + "cm^3"
                    print("totalVolumeString", totalVolumeString)
                else:
                    totalVolume = self.cm3_To_inch3Transform(totalVolume)
                    print("Total volume:", totalVolume, "inch^3")
                    totalVolumeString = "Total volume:" + str(totalVolume) + "inch^3"
                    print("totalVolumeString", totalVolumeString)
        except Exception as e:
            print(e)
...
def foo(mat, fileName):
    global material
    material = mat
    # if (metric == "inch"):
      #  mySTLUtils.calculateVolume(fileName, "inch")
    mySTLUtils = STLUtils()
    totalVolume = mySTLUtils.calculateVolume(fileName, "cm")
    return totalVolume
